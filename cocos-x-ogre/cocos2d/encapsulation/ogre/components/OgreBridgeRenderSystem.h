#ifndef OGRE_BRIDGE_RENDERSYSTEM_H
#define OGRE_BRIDGE_RENDERSYSTEM_H\

#include "OgreRenderSystem.h"

namespace Ogre
{
	class BridgeGpuProgramManager;
	class BridgeHardwareBufferManager;
    class BridgeHardwareTextureManager;
}

namespace Ogre
{
    class BridgeRenderSystem : public RenderSystem
    {
    ...
    public:
        ...
        VertexElementType getColourVertexElementType(void) const { return Ogre::VET_COLOUR_ABGR; }
    ...
    private:
		...
		BridgeGpuProgramManager *mGpuProgramManager;
        BridgeHardwareTextureManager *mTextureManager;
        BridgeHardwareBufferManager *mHardwareBufferManager;
    };
}
#endif //OGRE_BRIDGE_RENDERSYSTEM_H