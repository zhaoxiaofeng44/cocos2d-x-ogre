...
//		LogManager::getSingleton().logMessage("ParticleUniverse: Particle Renderer Type '" + type + "' registered");
	...
	//-----------------------------------------------------------------------
	void ParticleSystemManager::particleSystemTemplateNames(cache_std::vector<String>& v)
	{
...
//		}
	...
	void DepthMapTargetListener::preViewportUpdate(const Ogre::RenderTargetViewportEvent& evt)
	{
		...
		cache_std::vector<ParticleRenderer*>::iterator it;
		cache_std::vector<ParticleRenderer*>::iterator itEnd = mRenderers.end();
