...
namespace ParticleUniverse
{
	...
	ParticleRenderer::~ParticleRenderer(void)
	{
		...
		cache_std::vector<Ogre::FloatRect*>::iterator it;
		cache_std::vector<Ogre::FloatRect*>::iterator itEnd = mUVList.end();
	...
	//-----------------------------------------------------------------------
	const cache_std::vector<Ogre::FloatRect*>& ParticleRenderer::getTextureCoords(void) const
	{
		return mUVList;
	}
	//-----------------------------------------------------------------------
