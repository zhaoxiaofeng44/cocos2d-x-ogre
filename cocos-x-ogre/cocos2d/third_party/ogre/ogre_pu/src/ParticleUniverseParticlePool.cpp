...
namespace ParticleUniverse
{
	...
	{
		cache_std::vector<VisualParticle*>::iterator it;
	...
	{
		cache_std::vector<ParticleEmitter*>::iterator itEmitter;
	...
	{
		cache_std::vector<ParticleTechnique*>::iterator itTechnique;
	...
	{
		cache_std::vector<ParticleAffector*>::iterator itAffector;
	...
	void ParticlePool::destroyAllSystemParticles(void)
	{
		...
		cache_std::vector<String>::iterator itSystem;
