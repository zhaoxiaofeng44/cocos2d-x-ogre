...
namespace ParticleUniverse
{
	...
	void EntityRenderer::_destroyAll(void)
	{
		...
		cache_std::vector<EntityRendererVisualData*>::const_iterator it;
		cache_std::vector<EntityRendererVisualData*>::const_iterator itEnd = mAllVisualData.end();
	...
	{
		/** 
			- This renderer is a lacky?solution to display geometry-based particles. It pre-creates a 
	...
	void EntityRenderer::_setMaterialName(const String& materialName)
	{
		...
		cache_std::vector<Ogre::Entity*>::const_iterator itEntity = mEntities.begin();
		cache_std::vector<Ogre::Entity*>::const_iterator itEntityEnd = mEntities.end();
