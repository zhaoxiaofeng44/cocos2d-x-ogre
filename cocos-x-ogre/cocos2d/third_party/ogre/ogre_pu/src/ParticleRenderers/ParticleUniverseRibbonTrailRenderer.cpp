...
namespace ParticleUniverse
{
	...
	void RibbonTrailRenderer::_destroyAll(void)
	{
		...
		cache_std::vector<RibbonTrailRendererVisualData*>::const_iterator it;
		cache_std::vector<RibbonTrailRendererVisualData*>::const_iterator itEnd = mAllVisualData.end();
