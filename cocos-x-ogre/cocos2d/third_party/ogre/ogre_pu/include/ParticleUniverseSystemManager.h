...
namespace ParticleUniverse
{
	...
	class _ParticleUniverseExport DepthMapTargetListener : public Ogre::RenderTargetListener, public Ogre::RenderQueue::RenderableListener
	{
		public: 
			...
			cache_std::vector<ParticleRenderer*> mRenderers;
	};
		...
		public Ogre::Singleton<ParticleSystemManager>, public ScriptWriter
    {
		...
		protected:
	        ...
	        */
			...
			// Emitter Factories
			typedef cache_std::map<String, ParticleEmitterFactory*> EmitterFactoryMap;
			EmitterFactoryMap mEmitterFactories;

			// Affector Factories
			typedef cache_std::map<String, ParticleAffectorFactory*> AffectorFactoryMap;
			AffectorFactoryMap mAffectorFactories;

			// Observer Factories
			typedef cache_std::map<String, ParticleObserverFactory*> ObserverFactoryMap;
			ObserverFactoryMap mObserverFactories;

			// EventHandler Factories
			typedef cache_std::map<String, ParticleEventHandlerFactory*> EventHandlerFactoryMap;
			EventHandlerFactoryMap mEventHandlerFactories;

			// Renderer Factories
			typedef cache_std::map<String, ParticleRendererFactory*> RendererFactoryMap;
			RendererFactoryMap mRendererFactories;

			// Extern Factories
			typedef cache_std::map<String, ExternFactory*> ExternFactoryMap;
			ExternFactoryMap mExternFactories;

			// Behaviour Factories
			typedef cache_std::map<String, ParticleBehaviourFactory*> BehaviourFactoryMap;
			...
			*/
			typedef cache_std::map<String, IAlias*> AliasMap;
			AliasMap mAliasMap;
			...
			/*	The template map contains a list with all particle systems that act as a template.
				...
				particle systems.
			*/
			typedef cache_std::map<String, ParticleSystem*> ParticleSystemTemplateMap;
			...
			*/
			typedef cache_std::map<String, ParticleSystem*> ParticleSystemMap;
		...
		public:
			...
			*/
			void particleSystemTemplateNames(cache_std::vector<String>& v);
