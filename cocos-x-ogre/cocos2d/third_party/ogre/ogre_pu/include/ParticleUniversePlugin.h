...
namespace ParticleUniverse
{
	...
	protected:
		...
		cache_std::vector<ParticleRendererFactory*> mRendererFactories;
		cache_std::vector<ParticleEmitterFactory*> mEmitterFactories;
		cache_std::vector<ParticleAffectorFactory*> mAffectorFactories;
		cache_std::vector<ParticleObserverFactory*> mObserverFactories;
		cache_std::vector<ParticleEventHandlerFactory*> mEventHandlerFactories;
		cache_std::vector<ExternFactory*> mExternFactories;
		cache_std::vector<ParticleBehaviourFactory*> mBehaviourFactories;
	};
}
