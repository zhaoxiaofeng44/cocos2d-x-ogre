	...
	class _ParticleUniverseExport ParticleSystem : public Ogre::MovableObject, public Particle, public IElement
	{
		public:
		    ...
		    */
			...
			typedef cache_std::vector<ParticleSystemListener*>::iterator ParticleSystemListenerIterator;
			typedef cache_std::vector<ParticleSystemListener*> ParticleSystemListenerList;

			ParticleSystem(const String& name);
			ParticleSystem(const String& name, const String& resourceGroupName);
	        virtual ~ParticleSystem(void);

			void _updateTransformWithMatrixChange(void);  // for refresh 
		...
		protected:
	        ...
	        */
			...
			/** If set, the ParticleSystem automatically stops after FixedTimeout?seconds.
	        */
			Real mFixedTimeout;
