...
namespace ParticleUniverse
{
	...
	@remarks
		...
		depend on another value that changes over time. The thanging value?is wrapped into a IDependency class
		and the attribute is sontinuesly?changed by the IDependency subclass.
	*/
