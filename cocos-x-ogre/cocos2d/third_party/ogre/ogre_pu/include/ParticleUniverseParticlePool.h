    ...
    */
	class _ParticleUniverseExport ParticlePool
	{
		protected:
		    ...
		    */
			cache_std::vector<VisualParticle*> mVisualParticles;
			cache_std::vector<ParticleEmitter*> mEmitters;
			cache_std::vector<ParticleAffector*> mAffectors;
			cache_std::vector<ParticleTechnique*> mTechniques;
			cache_std::vector<String> mSystems; // Use names instead of pointers to avoid problems during cleanup.
