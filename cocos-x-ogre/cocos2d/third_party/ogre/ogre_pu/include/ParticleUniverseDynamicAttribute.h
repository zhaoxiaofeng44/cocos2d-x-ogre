...
namespace ParticleUniverse
{
	...
	*/
	...
	@remarks
		...
		of a value on the curve, while pline?generates a smooth curve and the returns a value that lies on that curve.
	*/
	class _ParticleUniverseExport DynamicAttributeCurved : public DynamicAttribute
    {
		public:
			typedef cache_std::vector<Vector2> ControlPointList;
