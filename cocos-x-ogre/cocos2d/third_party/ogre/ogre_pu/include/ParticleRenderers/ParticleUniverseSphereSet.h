	...
	class _ParticleUniverseExport SphereSet : public PrimitiveShapeSet
	{
		protected:
			...
			*/
			...
			typedef cache_std::list<Sphere*> ActiveSphereList;
			typedef cache_std::list<Sphere*> FreeSphereList;
			typedef cache_std::vector<Sphere*> SpherePool;
			...
			*/
			...
			typedef cache_std::vector<Ogre::FloatRect> TextureCoordSets;
